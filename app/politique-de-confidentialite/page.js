      ...
      <div className="relative flex flex-col text-center items-center lg:flex-row justify-center gap-8">
        <div className="flex flex-col lg:ml-20 relative w-[90vw] lg:w-[40vw]">
          ...
          >
            ...
            votre nom, votre adresse e-mail et votre numéro de téléphone. Nous
            utilisons ces informations uniquement dans le but de répondre à vos
            demandes et de vous fournir des informations sur nos services.
          </p>
          <br />
          <h2 className="capitalize text-black tracking-wider text-center text-xl xl:text-nowrap font-semibold mx-auto">
          ...
          >
            ...
            vendues, échangées ou louées à des tiers à des fins commerciales.
          </p>
          <br />
          <h2 className="capitalize text-black tracking-wider text-center text-xl xl:text-nowrap font-semibold mx-auto">
          ...
          >
            ...
            autorisé, la divulgation, l&apos;altération ou la destruction. Vous
            avez le droit de demander l&apos;accès à vos données personnelles,
            de les rectifier, de les supprimer ou de restreindre leur
            traitement. Vous avez également le droit de vous opposer au
            traitement de vos données personnelles ou de demander leur
            portabilité.
          </p>
          <br />
          <p
          ...
          >
            ...
            de protection des données, veuillez nous contacter à l&apos;adresse
            suivante : charpente.menuiserie.durand@gmail.com , ou directement
