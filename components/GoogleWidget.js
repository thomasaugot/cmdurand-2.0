...
function GoogleWidget() {
  return (
    <div className="p-6 my-auto bg-white flex flex-col items-center justify-center rounded-lg gap-4 lg:ml-6 form-shadow">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="secondary-button secondary-button-bg"
      >
        Donnez votre avis!
      </a>
    </div>
