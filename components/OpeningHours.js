...
const OpeningHours = () => {
  ...
  return (
    <div className="bg-transparent w-full max-w-md mx-auto lg:max-w-none lg:w-80 xl:w-96 px-4 lg:px-0">
      <h2
        className="tracking-wider font-semibold text-xl sm:text-2xl lg:text-3xl mb-6 sm:mb-8 text-black text-center lg:text-left"
      >
        Horaires
      </h2>
      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-4 mb-8 sm:mb-12">
        {schedule.map((item, index) => (
          <div key={index} className="flex justify-between items-center py-1">
            <p
              className="text-darkGrey tracking-wider font-semibold text-base sm:text-lg"
            >
              {item.day}
            </p>
            <p
              className={`text-darkGrey tracking-wider font-semibold text-base sm:text-lg ${item.hours === "Fermé" ? "text-gray-500" : ""}`}
            >
              {item.hours}
            </p>
          </div>
      ...
      <div className="text-center lg:text-left">
        <p
          className="tracking-wider font-semibold text-lg sm:text-xl lg:text-2xl mb-4 text-black leading-relaxed"
        >
        ...
        >
          ...
          <p
            className="tracking-wider font-semibold text-lg sm:text-xl text-darkGrey"
          >
            +33 6 76 50 85 51
          </p>
        </div>
