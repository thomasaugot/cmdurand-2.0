...
const ContactCTA = () => (
  <section className="py-20 px-4 sm:px-6 lg:px-12 bg-gradient-to-br from-primary to-primary/90 relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto text-center relative z-10">
      ...
      >
        <h3
          className={`font-roboto text-white text-sm font-bold mb-6 uppercase tracking-wider`}
        >
          Prêt à commencer ?
        </h3>
        ...
        <p
          className="text-white/80 text-xl mb-12 max-w-3xl mx-auto leading-relaxed"
        >
          Une question ? Un projet en tête ? N'hésitez pas à nous contacter pour
          échanger autour de vos besoins. Nous sommes là pour vous accompagner.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white hover:bg-white/90 text-primary font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:shadow-2xl flex items-center gap-3 text-lg"
          >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:shadow-2xl flex items-center gap-3 text-lg"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
