 ...
 <section className="relative pt-52 pb-24 px-6 lg:px-12 text-center overflow-hidden bg-darkGrey">
   ...
   >
     ...
     <h1 className={`${gotham.className} text-white text-4xl lg:text-6xl xl:text-7xl font-bold mb-8 leading-tight`}>
       <span className={`font-roboto text-primary`}>T</span>
     ...
     <p
       className="text-lightGrey text-xl lg:text-2xl max-w-4xl mx-auto mb-12"
     >
       Expertise en charpente et menuiserie depuis des années à Missillac.
       <br />
       Nous accompagnons particuliers et professionnels dans leurs projets les
       plus ambitieux.
     </p>
     ...
     <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
       <motion.a
         ...
         whileTap={{ scale: 0.95 }}
         className="bg-primary hover:bg-primary/90 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:shadow-xl flex items-center gap-3 text-lg"
       >
       ...
       <motion.a
         ...
         whileHover={{ scale: 1.05 }}
         whileTap={{ scale: 0.95 }}
         className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-darkGrey font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:shadow-xl flex items-center gap-3 text-lg"
       >
         <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
