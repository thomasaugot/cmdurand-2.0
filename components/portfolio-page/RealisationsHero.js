...
const RealisationsHero = () => (
 <section className="relative pt-52 pb-24 px-6 lg:px-12 text-center overflow-hidden bg-darkGrey">
   ...
   >
     <h1 className={`${gotham.className} text-white text-5xl lg:text-7xl font-bold mb-8`}>
       <span
         className={`font-roboto text-primary text-6xl lg:text-8xl`}
       >
         N
       </span>
     ...
     <p
       className="text-lightGrey text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed"
     >
       Découvrez quelques-uns de nos projets réalisés : charpente, menuiserie, extensions...
       Chaque réalisation témoigne de notre savoir-faire et de notre passion
