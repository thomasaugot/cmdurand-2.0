...
const AmenagementComblesCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Vos combles vous attendent !
        </h2>
        <p
          className="text-xl mb-8 opacity-90 leading-relaxed"
        >
          Transformez vos mètres carrés perdus en espaces de vie précieux.
          Bureau, chambre, salle de jeux... Donnons vie à vos projets ensemble.
        </p>
...
export default AmenagementComblesCTA;
