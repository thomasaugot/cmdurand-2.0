          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h3 className={`${dosisFont.className} text-3xl lg:text-4xl font-bold text-darkGrey mb-6`}>
                Exemple d'aménagement de combles
              </h3>
              <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
                Découvrez un exemple de transformation réussie. D'autres projets d'aménagement 
                viendront enrichir cette galerie très prochainement.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className={`${dosisFont.className} text-darkGrey leading-relaxed max-w-2xl mx-auto`}>
                Nous réalisons actuellement plusieurs projets d'aménagement de combles. 
      ...
      <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h3 className={`${dosisFont.className} text-3xl lg:text-4xl font-bold text-darkGrey mb-6`}>
              Nos aménagements de combles
            </h3>
            <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
              Découvrez nos transformations réussies d'espaces perdus en lieux de vie 
              fonctionnels et chaleureux.
            </p>
          </motion.div>
            ...
            {images.map((image, index) => (
              ...
              >
                <div className="relative aspect-[4/3]">
                  <Image
                    src={image}
                    alt={`Aménagement de combles ${index + 1}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-105"
...
export default AmenagementComblesGallery;