        ...
        <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              >
                Découvrez un exemple de transformation réussie. D'autres projets
                d'aménagement viendront enrichir cette galerie très
                prochainement.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                galerie dans les semaines à venir.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p
              className="text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed"
            >
              Découvrez nos transformations réussies d'espaces perdus en lieux
