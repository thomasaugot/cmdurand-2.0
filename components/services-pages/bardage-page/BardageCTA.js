...
const BardageCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Bois, composite, métal ou fibrociment : nous vous conseillons le bardage 
          idéal pour votre projet et votre budget. Protection et esthétique garanties !
        </p>
        ...
        <div className="mt-8">
          ...
          >
            → Voir toutes nos façades réalisées
          </Link>
        </div>
      </div>
    </motion.section>
