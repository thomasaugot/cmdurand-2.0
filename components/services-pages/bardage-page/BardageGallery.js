...
const BardageGallery = ({ images }) => {
  ...
  const openImageModal = (imageIndex) => {
    ...
    setSelectedImage({
      ...
      alt: `Bardage - Photo ${imageIndex + 1}`,
      title: "Réalisations en bardage",
      description: `Exemple de bardage ${imageIndex + 1}/${images.length}`
    });
  };
  ...
  const navigateImage = (direction) => {
    ...
    setSelectedImage({
      src: images[newIndex],
      alt: `Bardage - Photo ${newIndex + 1}`,
      title: "Réalisations en bardage",
      description: `Exemple de bardage ${newIndex + 1}/${images.length}`
    });
  };
