          ...
          >
            ...
            <div className="space-y-6">
              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                ...
                qualité pour protéger et embellir votre maison. Avec notre service de bardage, 
                nous vous offrons une gamme complète de revêtements extérieurs.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Que vous recherchiez un aspect traditionnel avec du bois naturel, une esthétique 
                moderne avec des matériaux composites, ou une solution pratique avec des revêtements 
                techniques, notre équipe expérimentée est là pour vous conseiller.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Le bardage ne se limite pas à l'esthétique ; il joue un rôle crucial dans la 
                protection contre les intempéries et l'amélioration de l'isolation thermique de 
                votre habitation.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className={`${dosisFont.className} text-darkGrey`}>
                Nous choisissons des matériaux durables et résistants, tout en vous offrant une 
                variété de styles et de finitions pour correspondre à vos préférences esthétiques.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                ...
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Types de bardage</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">40+</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Façades habillées</div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                ...
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Déperditions thermiques</div>
              </div>
            </div>
