        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Offrez une protection élégante à votre véhicule avec notre
                service de construction de carports. Nous comprenons
                l'importance de préserver votre voiture, votre caravane ou votre
                bateau des éléments extérieurs.
              </p>

              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Un carport bien conçu offre non seulement une protection contre
                les intempéries et les rayons du soleil, mais il constitue
                également un ajout fonctionnel et attrayant à votre espace
                extérieur.
              </p>
              ...
              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Que vous recherchiez un design moderne, classique ou sur mesure,
                notre équipe d'experts vous aide à créer un carport qui
                s'harmonise parfaitement avec le style de votre maison.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className="text-darkGrey">
                ...
                de construction robustes pour garantir la durabilité et la
                solidité de chaque carport.
              </p>
            </div>
          </motion.div>
