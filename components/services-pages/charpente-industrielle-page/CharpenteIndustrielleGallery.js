          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
                Découvrez un exemple de notre savoir-faire en charpente industrielle. 
                D'autres réalisations sont en cours et seront bientôt ajoutées à notre galerie.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className={`${dosisFont.className} text-darkGrey leading-relaxed max-w-2xl mx-auto`}>
                Nous travaillons actuellement sur plusieurs projets de charpente industrielle. 
                Ces nouvelles réalisations viendront enrichir notre galerie très prochainement.
              </p>
            </motion.div>
          </div>
        </section>
