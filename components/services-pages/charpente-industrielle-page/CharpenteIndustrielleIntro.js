          ...
          >
            ...
            <div className="space-y-6">
              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                ...
                C'est notre art, notre passion et notre expertise. Nous nous engageons à fournir à nos 
                clients des solutions innovantes et durables pour leurs projets de construction.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Que vous construisiez un entrepôt, un complexe industriel ou tout autre bâtiment 
                nécessitant une charpente solide, nous sommes là pour vous accompagner à chaque étape.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Notre équipe hautement qualifiée travaille avec précision et efficacité pour concevoir 
                et installer des charpentes qui répondent aux normes les plus strictes en matière de 
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className={`${dosisFont.className} text-darkGrey`}>
                Avec notre expérience éprouvée et notre engagement envers l'excellence, vous pouvez 
                avoir confiance que votre projet de charpente industrielle est entre de bonnes mains.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">500m2</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Surface maximale</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">15+</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Projets industriels</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">48h</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Délai d'étude</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">100%</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Aux normes</div>
              </div>
            </div>
