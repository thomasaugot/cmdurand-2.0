        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
              Découvrez quelques-unes de nos créations, témoignages de notre savoir-faire 
              et de notre passion pour l'art de la charpente traditionnelle.
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative">
              <Image
                src={selectedImage}
                alt={`Charpente traditionnelle ${currentIndex + 1}`}
                width={0}
                height={0}
                sizes="100vw"
