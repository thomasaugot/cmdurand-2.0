  ...
  const steps = [
    {
      ...
      description: "Analyse de votre projet, prise de mesures et conception des plans techniques adaptés à vos besoins."
    },
    {
      number: "02", 
      title: "Sélection du Bois",
      description: "Choix rigoureux des essences de bois français, contrôle qualité et préparation des pièces."
    },
    {
      number: "03",
      title: "Taille Traditionnelle",
      description: "Façonnage des pièces selon les techniques ancestrales, assemblages à tenons et mortaises."
    },
    {
      number: "04",
      title: "Levage & Montage",
      description: "Installation et assemblage sur site avec notre équipe de charpentiers expérimentés."
    }
  ];
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <h5 className={`${dosisFont.className} font-bold text-darkGrey mb-2`}>Durabilité</h5>
            ...
            <div>
              <div className="text-primary text-2xl mb-2">🌿</div>
              <h5 className={`${dosisFont.className} font-bold text-darkGrey mb-2`}>Écologie</h5>
              <p className={`${dosisFont.className} text-darkGrey text-sm`}>
