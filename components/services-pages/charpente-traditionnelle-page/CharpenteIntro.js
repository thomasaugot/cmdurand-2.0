        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Chez nous, la charpente traditionnelle incarne l'essence même du
                savoir-faire artisanal. Chaque pièce de bois est choisie avec
                soin, travaillée avec précision, pour créer des structures
                robustes et intemporelles.
              </p>

              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Notre équipe de charpentiers expérimentés met tout son cœur et
                son expertise dans chaque projet, qu'il s'agisse de la
                restauration d'une vieille maison de campagne ou de la
              ...
              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Nous comprenons l'importance de préserver les techniques
                traditionnelles tout en intégrant les innovations modernes pour
                garantir des résultats à la fois authentiques et durables.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className="text-darkGrey">
                Avec nous, votre charpente traditionnelle est bien plus qu'une
