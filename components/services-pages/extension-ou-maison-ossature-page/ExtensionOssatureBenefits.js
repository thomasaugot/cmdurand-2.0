  ...
  const benefits = [
    {
      ...
      description: "Montage en atelier puis assemblage sur site pour un chantier éclair",
      icon: "⚡"
    },
    {
      title: "Performance énergétique",
      description: "Isolation intégrée et étanchéité parfaite pour un confort optimal",
      icon: "🌡️"
    },
    {
    ...
    },
    {
      ...
      description: "Matériau renouvelable, stockage carbone et faible empreinte",
      icon: "🌱"
    }
  ];
  ...
  const types = [
    {
      ...
      features: ["Cuisine agrandie", "Salon supplémentaire", "Chambre parentale"],
      surface: "20-40m²"
    },
    {
    ...
    },
    {
      ...
      features: ["Chambres supplémentaires", "Bureau indépendant", "Salle de bains"],
      surface: "50-100m²"
    },
    {
      title: "Maison neuve",
      description: "Construction complète à ossature bois",
      features: ["Architecture moderne", "Haute performance", "Délais maîtrisés"],
      surface: "80-200m²"
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Analyse du terrain, contraintes réglementaires et techniques"
    },
    {
      step: "02", 
      title: "Conception & plans",
      description: "Élaboration des plans architecturaux et techniques détaillés"
    },
    {
      step: "03",
    ...
    },
    {
      ...
      description: "Assemblage sur site et réalisation des finitions intérieures"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
            L'ossature bois combine performance technique, rapidité de mise en œuvre 
