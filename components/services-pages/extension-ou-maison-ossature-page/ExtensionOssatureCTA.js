...
const ExtensionOssatureCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Prêt à agrandir votre espace de vie ?
        </h2>
        <p
          className={`${dosisFont.className} text-xl mb-8 opacity-90 leading-relaxed`}
        >
          Extension, surélévation ou construction neuve : nous donnons vie à vos projets 
          d'agrandissement avec l'expertise de l'ossature bois. Rapidité, performance et sur mesure !
        </p>
        ...
        <div className="mt-8">
          ...
          >
            → Découvrir toutes nos extensions
          </Link>
        </div>
      </div>
    </motion.section>
...
export default ExtensionOssatureCTA;