  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Extension, surélévation ou construction neuve : nous donnons vie à vos
          projets d'agrandissement avec l'expertise de l'ossature bois.
          Rapidité, performance et sur mesure !
        </p>
