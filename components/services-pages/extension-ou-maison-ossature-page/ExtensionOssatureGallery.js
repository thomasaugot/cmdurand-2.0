...
const ExtensionOssatureGallery = ({ images }) => {
  ...
  const openImageModal = (imageIndex) => {
    ...
    setSelectedImage({
      ...
      alt: `Extension ossature bois - Photo ${imageIndex + 1}`,
      title: "Extension & Ossature bois",
      description: `Extension ossature bois ${imageIndex + 1}/${images.length}`
    });
  };
  ...
  const navigateImage = (direction) => {
    ...
    setSelectedImage({
      src: images[newIndex],
      alt: `Extension ossature bois - Photo ${newIndex + 1}`,
      title: "Extension & Ossature bois",
      description: `Extension ossature bois ${newIndex + 1}/${images.length}`
    });
  };
      ...
      <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Nos extensions et constructions ossature bois
            </h3>
            <p
              className="text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed"
            >
              Découvrez nos réalisations : extensions de maisons, constructions
              neuves, agrandissements... Chaque projet unique raconte une
              histoire.
            </p>
          </motion.div>
            ...
            {images.map((image, index) => (
              ...
              >
                <div className="relative aspect-[4/3]">
                  <Image
                    src={image}
                    alt={`Extension ossature bois ${index + 1}`}
                    fill
...
export default ExtensionOssatureGallery;