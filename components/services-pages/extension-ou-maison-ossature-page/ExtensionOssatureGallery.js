        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
              Découvrez nos réalisations : extensions de maisons, constructions neuves, 
              agrandissements... Chaque projet unique raconte une histoire.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 bg-black/70 text-white p-4 rounded-lg backdrop-blur-sm">
              <p className={`${dosisFont.className} text-sm`}>
                Extension {currentIndex + 1} sur {images.length}
              </p>
            </div>
            ...
            <div className="relative">
              <Image
                src={selectedImage}
                alt={`Extension ossature bois ${currentIndex + 1}`}
                width={0}
                height={0}
                sizes="100vw"
