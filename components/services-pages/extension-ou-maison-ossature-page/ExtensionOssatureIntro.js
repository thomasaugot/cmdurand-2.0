          ...
          >
            ...
            <div className="space-y-6">
              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Votre rêve de maison prend forme avec notre expertise en extension et construction 
                à ossature. Nous comprenons que votre maison est bien plus qu'un simple bâtiment : 
                c'est votre refuge, votre havre de paix.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                L'ossature bois offre une flexibilité de conception incomparable, permettant des 
                espaces lumineux, aérés et personnalisés selon vos besoins et vos goûts.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Notre équipe qualifiée travaille en étroite collaboration avec vous à chaque étape 
                du processus, de la conception à la réalisation, pour s'assurer que votre projet 
                correspond parfaitement à votre vision.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className={`${dosisFont.className} text-darkGrey`}>
                Avec notre engagement envers la qualité, la durabilité et le service client, 
                vous pouvez avoir l'assurance que votre projet sera entre de bonnes mains.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">120m2</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Surface maximale</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">10+</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Extensions réalisées</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">6-8</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Semaines de chantier</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">-40%</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Consommation énergétique</div>
              </div>
            </div>
