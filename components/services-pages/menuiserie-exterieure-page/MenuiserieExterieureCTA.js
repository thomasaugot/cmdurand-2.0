  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Porte d'entrée, fenêtres, volets ou terrasse : nous créons la
          menuiserie extérieure qui sublime votre maison et résiste au temps. Du
          sur mesure, du savoir-faire !
        </p>
