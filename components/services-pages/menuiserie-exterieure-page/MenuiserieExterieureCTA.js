...
const MenuiserieExterieureCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Transformez vos extérieurs !
        </h2>
        <p
          className={`${dosisFont.className} text-xl mb-8 opacity-90 leading-relaxed`}
        >
          Porte d'entrée, fenêtres, volets ou terrasse : nous créons la menuiserie extérieure 
          qui sublime votre maison et résiste au temps. Du sur mesure, du savoir-faire !
        </p>
...
export default MenuiserieExterieureCTA;