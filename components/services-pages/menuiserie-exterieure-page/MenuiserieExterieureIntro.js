        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Chez Charpente Menuiserie Durand, notre engagement envers la
                qualité et l'excellence se reflète dans chaque détail de notre
                travail, même à l'extérieur de votre maison.
              </p>

              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Que vous souhaitiez installer une nouvelle porte d'entrée
                élégante, des fenêtres sur mesure, des volets en bois
                traditionnels ou encore une terrasse en bois, notre équipe
                qualifiée est là pour réaliser votre vision.
              </p>

              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Nous comprenons l'importance de choisir les bons matériaux et
                les bonnes finitions pour résister aux éléments extérieurs tout
                en ajoutant une touche d'esthétique à votre maison.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className="text-darkGrey">
                Nous travaillons avec vous pour concevoir et fabriquer des
                produits sur mesure qui complètent le style architectural de
                votre maison.
              </p>
            </div>
          </motion.div>
