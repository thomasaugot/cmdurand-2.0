...
const MenuiserieGeneraleCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Une idée de création sur mesure ?
        </h2>
        <p
          className={`${dosisFont.className} text-xl mb-8 opacity-90 leading-relaxed`}
        >
          Meuble, aménagement ou décoration : nous donnons vie à vos idées les plus créatives 
          avec le savoir-faire artisanal et la précision qui nous caractérisent !
        </p>
...
export default MenuiserieGeneraleCTA;