...
const MenuiserieGeneraleGallery = ({ images }) => {
  ...
  const openImageModal = (imageIndex) => {
    ...
    setSelectedImage({
      ...
      alt: `Menuiserie générale - Photo ${imageIndex + 1}`,
      title: "Menuiserie générale",
      description: `Création sur mesure ${imageIndex + 1}/${images.length}`
    });
  };
  ...
  const navigateImage = (direction) => {
    ...
    setSelectedImage({
      src: images[newIndex],
      alt: `Menuiserie générale - Photo ${newIndex + 1}`,
      title: "Menuiserie générale",
      description: `Création sur mesure ${newIndex + 1}/${images.length}`
    });
  };
        ...
        <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              >
                Exemple de menuiserie générale
              </h3>
              <p
              ...
              >
                ...
                générale. D'autres créations viendront enrichir cette galerie
                très prochainement.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                Nous réalisons actuellement de nombreuses créations sur mesure.
                Notre portfolio s'enrichira prochainement de toutes ces
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h3
              className="text-3xl lg:text-4xl font-bold text-darkGrey mb-6"
            >
              Nos créations en menuiserie générale
            </h3>
            <p
              className="text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed"
            >
              Découvrez nos réalisations sur mesure : meubles, aménagements et
              créations uniques qui subliment vos intérieurs.
            </p>
          </motion.div>
            ...
            {images.map((image, index) => (
              ...
              >
                <div className="relative aspect-[3/4]">
                  <Image
                    src={image}
                    alt={`Menuiserie générale ${index + 1}`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-105"
...
export default MenuiserieGeneraleGallery;