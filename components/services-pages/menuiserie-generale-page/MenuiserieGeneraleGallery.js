          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
                Découvrez un exemple de notre savoir-faire en menuiserie générale. 
                D'autres créations viendront enrichir cette galerie très prochainement.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className={`${dosisFont.className} text-darkGrey leading-relaxed max-w-2xl mx-auto`}>
                ...
                Notre portfolio s'enrichira prochainement de toutes ces nouvelles réalisations.
              </p>
            </motion.div>
          </div>
        </section>
      ...
      <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className={`${dosisFont.className} text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed`}>
              Découvrez nos réalisations sur mesure : meubles, aménagements 
              et créations uniques qui subliment vos intérieurs.
            </p>
          </motion.div>
