        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                Que ce soit pour la fabrication sur mesure de meubles, la pose
                de fenêtres et portes, ou la création d'éléments de décoration
                intérieure, notre équipe expérimentée met tout son savoir-faire
              ...
              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Nous comprenons que chaque détail compte, c'est pourquoi nous
                accordons une attention particulière à la sélection des
                matériaux et à la précision de la fabrication.
              </p>

              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Que vous souhaitiez apporter une touche d'élégance à votre
                intérieur ou améliorer la fonctionnalité de vos espaces, nous
                sommes là pour concrétiser vos idées avec des solutions sur
                mesure et durables.
              </p>
            </div>
