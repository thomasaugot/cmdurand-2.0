...
const PreauCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Un projet de préau en vue ?
        </h2>
        <p
          className={`${dosisFont.className} text-xl mb-8 opacity-90 leading-relaxed`}
        >
          Scolaire, résidentiel ou événementiel : créons ensemble l'espace couvert 
          qui répond à vos besoins. Protection et esthétique garanties !
        </p>
        ...
        <div className="mt-8">
          ...
          >
            → Découvrir nos autres constructions
          </Link>
        </div>
      </div>
    </motion.section>
