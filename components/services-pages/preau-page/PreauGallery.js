...
const PreauGallery = ({ images }) => {
  ...
  const openImageModal = (imageIndex) => {
    ...
    setSelectedImage({
      ...
      alt: `Préau et abri - Photo ${imageIndex + 1}`,
      title: "Préaux et abris",
      description: `Réalisation de préau ${imageIndex + 1}/${images.length}`
    });
  };
  ...
  const navigateImage = (direction) => {
    ...
    setSelectedImage({
      src: images[newIndex],
      alt: `Préau et abri - Photo ${newIndex + 1}`,
      title: "Préaux et abris",
      description: `Réalisation de préau ${newIndex + 1}/${images.length}`
    });
  };
      ...
      <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Nos préaux et abris réalisés
            </h3>
            <p
              className="text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed"
            >
              Découvrez nos constructions d'espaces couverts : préaux scolaires,
              abris de jardin et espaces de vie extérieure.
            </p>
          </motion.div>
