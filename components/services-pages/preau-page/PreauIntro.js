          ...
          >
            ...
            <div className="space-y-6">
              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Un préau bien conçu offre non seulement une protection contre les intempéries, 
                mais crée également un espace polyvalent et accueillant pour se détendre, 
                se divertir ou simplement profiter de la nature.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Notre équipe d'experts travaille avec vous pour concevoir et construire un préau 
                sur mesure qui répond à vos besoins spécifiques et s'intègre harmonieusement 
                à votre environnement.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Que vous recherchiez un design contemporain, rustique ou traditionnel, nous mettons 
                à votre disposition notre savoir-faire et notre créativité pour réaliser votre vision.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className={`${dosisFont.className} text-darkGrey`}>
                Avec des matériaux de haute qualité et une attention méticuleuse aux détails, 
                nous créons un préau durable, fonctionnel et esthétique.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                ...
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Préaux construits</div>
              </div>
