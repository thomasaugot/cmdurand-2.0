...
const SolivageCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Un projet de structure porteuse ?
        </h2>
        <p
          className="text-xl mb-8 opacity-90 leading-relaxed"
        >
          Construction neuve ou renforcement existant : nos experts calculent et
          réalisent vos solivages pour une solidité optimale. Fiabilité garantie
          !
        </p>
        ...
        <div className="mt-8">
          ...
          >
            → Voir nos autres structures réalisées
          </Link>
        </div>
      </div>
    </motion.section>
