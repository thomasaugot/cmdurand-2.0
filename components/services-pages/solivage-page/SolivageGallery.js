      ...
      <section className="py-20 px-6 lg:px-12 bg-lightGrey/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Nos structures porteuses réalisées
            </h3>
            <p
              className="text-darkGrey text-lg max-w-3xl mx-auto leading-relaxed"
            >
              Découvrez nos réalisations de solivage et planchers techniques :
              précision, solidité et durabilité au service de vos projets.
            </p>
          </motion.div>
...
export default SolivageGallery;
