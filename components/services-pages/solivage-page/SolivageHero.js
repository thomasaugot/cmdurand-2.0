...
const SolivageHero = () => (
  <section className="relative pt-52 pb-24 px-6 lg:px-12 text-center overflow-hidden bg-darkGrey brick-bg-dark">
    ...
    >
      ...
      >
        {" "}
        <span className={`font-roboto text-primary`}>S</span>
        tructures Porteuses <span className="text-primary">Solides</span>
      </h1>

      <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>

      <p className="text-lightGrey text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed">
        Solivage porteur et planchers techniques pour des fondations durables
      </p>
    </motion.div>
  </section>
);

export default SolivageHero;
