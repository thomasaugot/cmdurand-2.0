          ...
          >
            ...
            <div className="space-y-6">
              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                ...
                nos experts en solivage porteur sont là pour vous accompagner à chaque étape du processus.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Nous commençons par une évaluation approfondie de vos besoins et de la structure de votre 
                bâtiment, afin de concevoir un plan de solivage qui garantit une distribution uniforme 
                de la charge et une solidité optimale.
              </p>

              <p className={`${dosisFont.className} text-darkGrey text-lg leading-relaxed`}>
                Grâce à notre expérience dans le domaine de la charpente, nous proposons une variété 
                de solutions de solivage porteur, allant des méthodes traditionnelles aux techniques modernes.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className={`${dosisFont.className} text-darkGrey`}>
                Matériaux de haute qualité et techniques éprouvées pour assurer durabilité 
                et longévité, dans le respect des normes de sécurité en vigueur.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">150m2</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Surface maximale</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">20+</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Planchers réalisés</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">2-3</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Semaines d'intervention</div>
              </div>
              
              <div className="bg-white rounded-xl shadow-custom-light p-6 text-center">
                <div className="text-3xl font-bold text-primary mb-2">50</div>
                <div className={`${dosisFont.className} text-darkGrey font-medium`}>Ans de durabilité</div>
              </div>
            </div>
