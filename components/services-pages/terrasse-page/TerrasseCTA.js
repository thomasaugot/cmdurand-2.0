...
const TerrasseCTA = ({ handleToggleForm }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        >
          Prêt à créer votre terrasse de rêve ?
        </h2>
        <p
          className={`${dosisFont.className} text-xl mb-8 opacity-90 leading-relaxed`}
        >
          Bois exotique, composite ou européen : nous concevons la terrasse parfaite 
          pour votre mode de vie. Confort et esthétique garantis !
        </p>
        ...
        <div className="mt-8">
          ...
          >
            → Découvrir toutes nos terrasses
          </Link>
        </div>
      </div>
    </motion.section>
