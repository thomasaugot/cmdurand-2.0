          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                services de construction de terrasses. Nous comprenons
                l'importance d'avoir un espace extérieur fonctionnel et
                accueillant.
              </p>
              ...
              <p
                className="text-darkGrey text-lg leading-relaxed"
              >
                Que vous rêviez d'une terrasse en bois chaleureuse et rustique
                ou d'une terrasse en composite moderne et facile d'entretien,
              ...
              >
                ...
                concevoir et construire une terrasse qui répond à vos besoins, à
                votre style de vie et à votre budget.
              </p>
            </div>
            ...
            <div className="bg-primary/10 rounded-xl p-6">
              ...
              <p className="text-darkGrey">
                Nos terrasses sont construites avec des matériaux de haute
                qualité et des techniques robustes pour assurer leur durabilité
                et leur longévité.
              </p>
            </div>
          </motion.div>
